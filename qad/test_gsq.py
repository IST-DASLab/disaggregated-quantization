...
def test_construction():
    ...
    from gsq2bit import GSQ2BitLinear
...
def test_apply_and_registry():
    ...
    from gsq2bit import apply_gsq2bit, apply_gsq3bit, GSQLinear
...
def test_param_groups():
    ...
    from gsq2bit import GSQLinear, gsq_param_groups
    class M(nn.Module):
...
def test_dist_integration():
    ...
    from gsq2bit import apply_gsq2bit, post_update_all, gsq_param_groups
